...
8. **Bracket connector lines** — knockout cards now have CSS connector lines.
...
1. **Keep the 10:30 PM PDT daily update** — the nightly workflow rolls the snapshot forward.
